...
This protocol describes the WebSocket API interface that Hotbit Korea trading system provides for external users, which can generally be categorized into three types:
